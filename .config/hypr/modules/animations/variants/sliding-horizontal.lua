...
hl.animation({ leaf = "borderangle", enabled = true, speed = 6, bezier = "liner" })
...
hl.animation({ leaf = "fadeOut", enabled = true, speed = 3, bezier = "winOut" })
...
hl.animation({ leaf = "layersOut", enabled = true, speed = 1.5, bezier = "menu_accel", style = "slidefade" })
...
hl.animation({ leaf = "specialWorkspaceIn", enabled = true, speed = 4.3, bezier = "md3_decel", style = "slide top" })
hl.animation({ leaf = "specialWorkspaceOut", enabled = true, speed = 4.3, bezier = "md3_decel", style = "slide bottom" })
